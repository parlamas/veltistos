...
export const ipArticles: IpArticle[] = [
  {
    ...
    Οπως βλεπετε στην εικονα, στην Ιωνικη διαλεκτο, η λεξη <span class="wow">μονος</span> ελεγετο <span class="wow">μουνος</span>. Στα Αρχαια, το νυχι ειναι αρσενικου γενους:
     ...
     δηλαδη <b>οπλη</b>.<p>
      ...
      Η οπλη δεν ειναι τιποτε αλλο παρα <span class="ub">ενα τεραστιο νυχι</span>. Τα αλογα ειναι μούνυχα ζωα. Οι κατσικες ειναι δίνυχα ζωα, διοτι εχουν 2 νυχια, δηλαδη 
      η οπλη της κατσικας ειναι δίνυχη. <img src="/mouni/goat-hoof.webp" width=50 height=50 style="float:left; margin:0 .75rem .5rem 0; border-radius:6px;" /><p>

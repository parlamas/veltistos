...

  {
    ...
    Οπως βλεπετε στην εικονα, στην Ιωνικη διαλεκτο, η λεξη <span class="wow">μονος</span> ελεγετο <span class="wow">μουνος</span>. Στα Αρχαια, το νυχι ειναι αρσενικου γενους:
     ...
     δηλαδη <b>οπλη</b>.<p>
      ...
      Η οπλη δεν ειναι τιποτε αλλο παρα <span class="ub">ενα τεραστιο νυχι</span>. Τα αλογα ειναι μούνυχα (μονόχηλα) ζωα. Οι κατσικες ειναι δίνυχα (δίχηλα) ζωα, διοτι εχουν 2 νυχια, δηλαδη 

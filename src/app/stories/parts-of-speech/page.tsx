  ...
  return (
    ...
    >
      ...
      */}
      ...
      <li><span className="wow">Ουσιαστικα:</span> (α) Ειναι αυτη η λεξη το ονομα καποιας οντότητας; (ναι) 
      (β) Ειναι αυτη η λεξη μερος καποιου χρονου; (οχι) (γ) Εισαγει αυτη η λεξη μια ελλειπτικη μετοχικη προταση; (οχι)</li>
      <li><span className="wow">Επιθετα:</span> Προσδιοριζει αυτη η λεξη καποιο ουσιαστικο; (ναι)</li>

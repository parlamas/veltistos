...
<audio controls>
  ...
  `,
    tts:
      "Κατέβηκα χθες στον Πειραιά μαζί με τον Γλαύκωνα, τον γιο του Αρίστωνα, και για να προσευχηθώ στη θεά αλλά και επειδή ήθελα να δω με ποιον τρόπο θα τελέσουν τη γιορτή, αφού τώρα την έκαναν για πρώτη φορά. Μου φάνηκε ωραία η πομπή των εντοπίων, ωστόσο εξίσου όμορφη μου φάνηκε και η πομπή των Θρακών.",
    lang: "el-GR",
  },
};

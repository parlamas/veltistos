...
export default function Page() {
  ...
  const shareTitle = titleGR; // single string for Share/TTS/etc.
  ...
  return (
    <>
      ...
      >
        ...
        {/* Three images in a responsive row (stack on mobile) */}
        ...
        <LangShow>
          <AutoLangGroups>
            {/* ——— Greek ——— */}
            <p lang="el">Μια Σεμνη Προταση για το Επομενο Νομπελ Ειρηνης.</p>
            ...
            <p lang="el">
              Αλλωστε, η συνεπεια ειναι η ψυχη της αξιοπιστιας. Το Νομπελ Ειρηνης του Κισινγκερ το 1973 αναγνωρισε τις ακουραστες προσπαθειες του ι
              φερει «ειρηνη με τιμη» — μια φραση που ταυτιστηκε με τις ζουγκλες που δεχτηκαν ναπαλμ. Γιατι να σταματησουμε εκει; Κι ο Νετανιαχου
            ...
            <p lang="el">
              ...
              Νετανιαχου: μια ευγενης γενεαλογια ανδρων που μας θυμιζουν οτι η ειρηνη, για να ληφθει στα σοβαρα, πρεπει πρωτα να προηγηθει της σφαγης.
            ...
            <p lang="el">
              ...
              ακλονιτη πιστη στο θεικο του δικαιωμα στην αυτοαμυνα — αυτα ειναι τα διακριτικα γνωρισματα ενος αληθινου βραβευμενου. Κι αν η Επιτροπη επιθυμει
              ...
              μια ολοκληρη εξωτερικη πολιτικη ενσαρκωμενη σε ενα ατομο — η ιδιωτικοποιηση της κρατικης βιας, το επιχειρηματικο προσωπο των καλυτερων εξαγωγων του δυτικου 
              πολιτισμου.
            </p>
            ...
            {/* ——— English ——— */}
            <p lang="en">A Modest Proposal for the Next Nobel Peace Prize.</p>

            <p lang="en">
              It is time, surely, for the Nobel Committee to restore its old traditions. Traditions are sacred — and few are as venerable as the
              ...
              Laos can now, with equal moral precision, honor Benjamin Netanyahu.
            </p>

            <p lang="en">
              After all, consistency is the soul of credibility. Kissinger’s Peace Prize in 1973 recognized his tireless efforts to bring
              ...
              properly defined, can only be achieved through the systematic erasure of whatever stands in its way.
            </p>

            <p lang="en">
              Yes, Trump deserves mention — a mere enabler, a supplier of weapons and smiles — but not the spotlight. The true artisans of peace are
              ...
              line between irony and insult with unparalleled grace.
            </p>

            <p lang="en">
              Let us remember the precedent. In the same year Kissinger accepted his award — modestly, of course, and with only a few million casualties
              ...
              defined not by silence but by the thunder of well-intentioned explosions.
            </p>

            <p lang="en">
              So why hesitate now? Netanyahu’s resume glitters. Flattened neighborhoods, children under rubble, an unshakable belief in his divine right
              ...
              violence, the entrepreneurial face of Western civilization’s finest exports.
            </p>

            <p lang="en">
              Awarding the Nobel Peace Prize to Netanyahu and Breivik together would close the circle. It would tell the truth, at last, about what “peace” has
              come to mean in our time: the peace of submission, the peace of graves, the peace negotiated by drones and cement walls.
              The Nobel Committee, born of idealism, could die of honesty — and perhaps that would be its most peaceful act yet.
            </p>
          </AutoLangGroups>
        </LangShow>
